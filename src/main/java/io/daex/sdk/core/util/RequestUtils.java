...
import io.daex.sdk.core.http.HttpMediaType;
import io.daex.sdk.core.http.InputStreamRequestBody;
...
/**
 * Utility functions to use when creating a {@link io.daex.sdk.core.http.RequestBuilder }.
 *
 */
public final class RequestUtils {
   ...
   */
  public static synchronized String getUserAgent(String sdkName) {
    if (userAgent == null) {
      userAgent = buildUserAgent(sdkName);
    }
    return userAgent;
  }
   ...
   */
  private static String buildUserAgent(String sdkName) {
    final List<String> details = new ArrayList<String>();
    for (String propertyName : properties) {
      details.add(propertyName + "=" + System.getProperty(propertyName));
    }

    return "DAEX-java-SDK-"+sdkName+"/" + " (" + RequestUtils.join(details, "; ") + ")";
  }
